package com.bwf.hiit.workouts.butt.exercises.home.fitness.utils;
...
public class Utils {
    ...
    public static void onRateUs(Context context) {
        ...
        try {
            context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.bwf.hiit.workouts.butt.exercises.home.fitness")));
        } catch (ActivityNotFoundException anfe) {
            context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/developer?id=com.bwf.hiit.workouts.butt.exercises.home.fitness")));
        }
    }
}
